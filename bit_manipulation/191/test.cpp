...
int main(void) {
    vector<uint32_t> nums = {0b00000000000000000000000000001011, 0b00000000000000000000000010000000, 0b11111111111111111111111111111101};
    vector<uint32_t> expected = {3, 1, 31};
